...
000200  PROGRAM-ID. readcredits.
000300  AUTHOR. Marco Cella.
000400  Installation. Read the account credit transactions.
...
012100     MOVE ACCOUNT-IKEY TO DESTINATION-ID.
012200     MOVE 0 TO WS-ENDOFFILE.
012300     OPEN INPUT DATAFILE.
012400       START DATAFILE KEY IS EQUAL TO DESTINATION-ID
012500         INVALID KEY
...
013200               NOT AT END
013300                 IF NOT WS-DESTINATION-ID = ACCOUNT-IKEY 
